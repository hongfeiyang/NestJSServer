...
let VacancyResolver = (() => {
    let VacancyResolver = class VacancyResolver {
        ...
        async getAllVacancies(user) {
            const customerId = user.customerId;
            return this.vacancyService.getAllVacancies(customerId);
        }
        async me(user) {
            return user;
        }
    ...
    ], VacancyResolver.prototype, "getAllVacancies", null);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [String]),
        __metadata("design:returntype", Promise)
    ], VacancyResolver.prototype, "getCompany", null);
